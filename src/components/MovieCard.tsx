...
export function MovieCard() {
    return (
        <div className='max-w-[342px] max-h-[270px] hover:-translate-y-4 transition-all ease-in-out duration-300'>
            ...
            <div className='flex mt-4'>
                ...
                <div className='flex gap-3 items-center'>
                    ...
                    <div className='relative group'>
                        ...
                        <div className='absolute opacity-0 group-hover:opacity-100 right-[6px] -top-8 group-hover:-top-4 translate-x-1/2 -translate-y-full bg-dark-contrast-dark px-4 py-1 rounded-sm transition-all ease-in-out duration-300'>
            ...
            <div className='flex justify-between mt-4'>
                <div className='flex gap-3'>
                    <img src={Clock} alt="icone da duração do filme" />
                    <p className='font-inter'>2:00:00</p>
                </div>
                <div className='flex gap-3'>
